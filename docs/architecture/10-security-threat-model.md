...
| T28 | DynamoDB/S3 partial failure creates unauthorized artifact | inconsistency | transactions; pending export objects inaccessible without view; audit mutation atomic | orphan lifecycle/metrics |
