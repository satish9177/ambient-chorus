...
| SES | `execution.sending/sent/failed/unknown/reconciled`; execution ID, safe error, SES ID when known. **Never** the subject, either body, a claim, a caveat, a recipient address, or a reply-to address |
