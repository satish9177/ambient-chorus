"""The Monitor artifact's direct-code entrypoint, unpacked to the archive root as ``main.py``.
...
``runtimes.monitor`` -- the package ships beside it under the same root, exactly as it sits in
the repository.
"""
...
from runtimes.monitor.entrypoint import (  # noqa: E402 - imports chorus; needs the bootstrap above
